...
return `${teks.titulo} (Baixado por ${NomeDoBot})`
}
...
exports.commandNotFound = (command, tempo, sender, prefix, hora) => { 
return `
       ╭︎⊰  ⛧  ⛧  ⛧  ⛧  ⛧  ⊱╮︎    
❌  ×  ᴄᴏᴍᴀɴᴅᴏ ɴãᴏ ʀᴇᴄᴏɴʜᴇᴄɪᴅᴏ  ×  ❌ 
       ╰═•  オ  オ  オ  オ  オ  •═╯
┃│ ✰ۣۜۜ͜͡⚡ ➠ *ᴄᴏᴍᴀɴᴅᴏ*: ${prefix+command}
┃│ ✰ۣۜۜ͜͡⚡ ➠  *${tempo}* ⟷ @${sender.split(`@`)[0]}
┃│ ✰ۣۜۜ͜͡⚡ ➠  *ᴅɪɢɪᴛᴇ* ${prefix}ᴍᴇɴᴜ ᴇ ʟᴇɪᴀ ᴏꜱ ᴄᴏᴍᴀɴᴅᴏꜱ.
┃│ ✰ۣۜۜ͜͡⚡ ➠  *ʜᴏʀᴀ* ➢ ${hora}
┗ ───────────────────`
}
...
exports.speedInatsu = (tempo, sender, r, kyun, uptime, infoSystem) => {
...
return `Para de flodar, poha 😡\nAgora espera *5* Segundos ai.`
}
